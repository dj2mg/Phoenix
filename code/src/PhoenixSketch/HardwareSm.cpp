 ...
 *
 * 2. RF Hardware States (managed by this module — HardwareSm is hand-written, NOT
 ...
 *    - RFCal* (e.g. RFCalReceiveIQ): calibration signal paths; these drive the four
 *      generated calibration sub-state-machines
 *
